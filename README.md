...
Приватный файловый менеджер, работающий через Telegram. Поддерживает MongoDB для надежного хранения данных, Local Bot API для локального развертывания бота, загрузку и скачивание файлов, управление правами доступа. Обеспечивает удобный интерфейс для работы с файлами, шифрование для безопасности, мультипользовательский доступ и настройку через Telegram-команды. Идеально для личного или командного использования. Развертывание на собственных серверах для полной приватности.
