...
Данный Telegram бот предназначен для удаленного управления файлами на ПК или удаленном сервере. Идеально подойдет для личного или командного использования.  
Бот обеспечивает удобный и интуитивно понятный интерфейс для работы. Реализована умная система доступа, логирования и администрирования внутри бота.  
Все данные о пользователях, папках и файлах бот хранит в MongoDB. Сами файлы хранятся на диске вашего ПК или на удаленном сервере.
...
* Отправка файлов на свой ПК или удаленный сервер, прямо через Telegram бота (до 2ГБ, при использовании Local Bot API).  
...
* Удобная система логирования действий с папкой и файлами.  
